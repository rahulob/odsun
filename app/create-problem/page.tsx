...
import Description from "../problem/components/description";
...
export default function CreateOrUpdateProblem() {
  const router = useRouter();
  const searchParams = useSearchParams();
  const problemSlug = searchParams.get("slug"); // Get problem slug from URL query
